...
parser.add_argument('--dataset', type=str, default="", help='Dataset you are using.')
...
FC_LAYERS = [1024, 1024]
TRAIN_DIR = "/home/tangxi.zq/code+data/kaggle_deepfake/kaggle_data" + "/train/"
VAL_DIR = "/home/tangxi.zq/code+data/kaggle_deepfake/kaggle_data" + "/val/"
...
if args.mode == "train":
    ...
    finetune_model = utils.build_finetune_model(base_model, num_classes=len(class_list),dropout=args.dropout,fc_layers=FC_LAYERS)
